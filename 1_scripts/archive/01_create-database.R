...
## rof_bam_pts_ss
load("0_data/raw/rof_bam_pts_ss.Rdata")
xx1 <- rof_bam_pts_ss
rm(rof_bam_pts_ss)
e <- new.env()
load("0_data/raw/RoF_SpaDESspatialpointcountdata_Feb27.RData", envir = e)
names(e)
...
# eskers
load("0_data/raw/RoF_SpaDESspatialpointcountdata_April17.RData")
